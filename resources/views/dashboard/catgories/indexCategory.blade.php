            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <h4 class="text-black">Category Table</h4>
                        <a href="{{route('addCategory')}}" class="btn btn-sm btn-warning">Add Category</a>
                    </div>
                    <p></p>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex g-2">
                                                        <form action="{{route('editCategory',$item->id)}}" method="get">
                                                            @csrf
